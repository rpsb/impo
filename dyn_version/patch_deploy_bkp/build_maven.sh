...
#-------------DUMMY STEP------------------------
rm /home/wasadmin/release/jenkinsworkspace/Brokerage_Dynamic_Versioning_8_2_2/fdDbProcedures/build.xml
cp /home/wasadmin/release/scripts/dyn_version/build.xml /home/wasadmin/release/jenkinsworkspace/Brokerage_Dynamic_Versioning_8_2_2/fdDbProcedures/build.xml
...
cp $JENKINS_WORKSPAGE/fdBrk/target/fdBrk-$JAR_VERSION.ear $JENKINS_WORKSPAGE/fdEJB/target/preejb_fdBrk-$JAR_VERSION.ear
...
cp $EAR_DIR/fdEJB-$JAR_VERSION.jar $JENKINS_WORKSPAGE/fdEJB/target/classes
