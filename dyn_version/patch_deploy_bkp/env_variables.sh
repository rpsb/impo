...
BUILD_VERSION=8_2_5; export BUILD_VERSION
VERSION_NUMBER=8.2.5; export VERSION_NUMBER
JAR_VERSION="8.2.5-81219"
JENKINS_JOB=Brokerage_Dynamic_Versioning_8_2_5; export JENKINS_JOB
...
EAR_DIR=$JENKINS_WORKSPAGE/fdEJB/target; export EAR_DIR
...
EJB_PRE_EAR="preejb_fdEJB-$JAR_VERSION.jar"; export EJB_PRE_EAR
EAR_FILE="fdEJB-$JAR_VERSION.jar"; export EAR_FILE
...
MAVEN_REP=/fdx/FDX_MVN_REPO_8_2_5/com/fd/brokerage; export MAVEN_REP

JENKINS_JOB_URL=http://10.20.40.166:8080/job/Brokerage_Dynamic_Versioning_8_2_5/lastSuccessfulBuild/buildNumber; export JENKINS_JOB_URL
